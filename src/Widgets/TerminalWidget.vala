...
namespace PantheonTerminal {
    ...
    public class TerminalWidget : Vte.Terminal {
        ...
        const string SEND_PROCESS_FINISHED_BASH = "dbus-send --type=method_call --session --dest=" + Build.EXEC_NAME + " " + Build.URI_ROOT + " " + Build.EXEC_NAME + ".ProcessFinished string:$PANTHEON_TERMINAL_ID string:\"$(history 1 | cut -c 8-)\" >/dev/null 2>&1; ";
